...
#include "@{TPL_MODULE_NAME}InteractiveTool.generated.h"


/**
 * Builder for U@{TPL_MODULE_NAME}InteractiveTool
 */
UCLASS()
class U@{TPL_MODULE_NAME}InteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the U@{TPL_MODULE_NAME}InteractiveTool
 */
UCLASS(Transient)
class U@{TPL_MODULE_NAME}InteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	U@{TPL_MODULE_NAME}InteractiveToolProperties();
...
/**
 * U@{TPL_MODULE_NAME}InteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class U@{TPL_MODULE_NAME}InteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<U@{TPL_MODULE_NAME}InteractiveToolProperties> Properties;
