...
#include "@{TPL_MODULE_NAME}EditorMode.generated.h"
 ...
 */
UCLASS()
class U@{TPL_MODULE_NAME}EditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_@{TPL_MODULE_NAME}EditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	U@{TPL_MODULE_NAME}EditorMode();
	virtual ~U@{TPL_MODULE_NAME}EditorMode();
