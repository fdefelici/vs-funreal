...
#include "@{TPL_MODU_NAME}InteractiveTool.generated.h"


/**
 * Builder for U@{TPL_MODU_NAME}InteractiveTool
 */
UCLASS()
class U@{TPL_MODU_NAME}InteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the U@{TPL_MODU_NAME}InteractiveTool
 */
UCLASS(Transient)
class U@{TPL_MODU_NAME}InteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	U@{TPL_MODU_NAME}InteractiveToolProperties();
...
/**
 * U@{TPL_MODU_NAME}InteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class U@{TPL_MODU_NAME}InteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<U@{TPL_MODU_NAME}InteractiveToolProperties> Properties;
